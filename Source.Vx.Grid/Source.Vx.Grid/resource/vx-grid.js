                    ...
                    $scope.resetVxInstance = function () {
                        ...
                        _.each($scope.vxConfig.columnDefConfigs, function (col) {
                            ...
                            if (col.inlineEditOnColumnEnabled == true) {
                                if (col.editDefnTemplate == '' || col.editDefnTemplate == null)
                                    col.editDefnTemplate = 'input';
                                if (col.editDefnTemplate == 'input')
                                    col.editDefn = '<input class="vx-edit-input form-control" ng-model="VX_DATA_POINT" />';
                                else if (col.editDefnTemplate == 'textarea')
                                    col.editDefn = '<textarea class="vx-edit-textarea form-control" ng-model="VX_DATA_POINT"></textarea>';
